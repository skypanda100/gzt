...
class ComparisonByWeekOfPie extends Component {
    ...
    post(postData, dispatch) {
        fetch('http://192.168.1.3:8765/gzt/server/sleep/comparison_by_week/comparison_by_week_of_pie.php', {
            method: 'POST',
            headers: {
...
export default withWidth()(ComparisonByWeekOfPie);
