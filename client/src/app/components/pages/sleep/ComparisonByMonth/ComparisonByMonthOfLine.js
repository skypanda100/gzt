...
class ComparisonByMonthOfLine extends Component {
    ...
    post(postData, dispatch) {
        fetch('http://192.168.1.3:8765/gzt/server/sleep/comparison_by_month/comparison_by_month_of_line.php', {
            method: 'POST',
            headers: {
    ...
    draw(data){
        ...
        if(data.isSuccess){
            ...
            date_r = data_r_r.date_month;
            gg_deep_r = data_r_r.gg_deep_month;
            gg_shallow_r = data_r_r.gg_shallow_month;
            zdt_deep_r = data_r_r.zdt_deep_month;
            zdt_shallow_r = data_r_r.zdt_shallow_month;
        }
...
export default withWidth()(ComparisonByMonthOfLine);
