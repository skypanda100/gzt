...
class ComparisonByDayOfTemperature extends Component {
    ...
    post(postData, dispatch) {
        fetch('http://192.168.1.3:8765/gzt/server/sleep/comparison_by_day/comparison_by_day_of_temperature.php', {
            method: 'POST',
            headers: {
...
export default withWidth()(ComparisonByDayOfTemperature);
