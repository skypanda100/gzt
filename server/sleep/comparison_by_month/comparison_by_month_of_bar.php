...
$data_r = array("date_month" => $date_month_r
, "gg_deep_month" => $gg_deep_month_r
, "gg_shallow_month" => $gg_shallow_month_r
, "zdt_deep_month" => $zdt_deep_month_r
, "zdt_shallow_month" => $zdt_shallow_month_r
);
